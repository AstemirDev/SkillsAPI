...
public class LivingAdvancedRenderEvent<T extends LivingEntity> extends Event {

    private T entityLiving;
    private PoseStack matrixStack;

    public LivingAdvancedRenderEvent(T entityLiving, PoseStack matrixStack) {
        this.entityLiving = entityLiving;
        this.matrixStack = matrixStack;
    }

    public static class Rotation<T extends LivingEntity> extends LivingAdvancedRenderEvent<T>{
    ...
    public static class Scale<T extends LivingEntity> extends LivingAdvancedRenderEvent<T>{
