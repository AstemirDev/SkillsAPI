...
public abstract class AdvancedLivingRenderer<T extends LivingEntity,M extends EntityModel<T>> extends LivingEntityRenderer<T,M> {
    ...
    public AdvancedLivingRenderer(EntityRendererProvider.Context context, EntityModelWrapper entityModel) {
    ...
    private <E extends Entity> void renderLeash(T p_115462_, float p_115463_, PoseStack p_115464_, MultiBufferSource p_115465_, E p_115466_) {
        ...
        int j = p_115462_.level.getBrightness(LightLayer.BLOCK,blockpos1);
