...
public class ModelElement {
    ...
    public ModelElement(String name, float textureWidthIn, float textureHeightIn, float textureOffsetXIn, float textureOffsetYIn) {
        this.name = name;
    ...
    private ModelElement cube(Vector2 textureOffset, Vector3 position, Vector3 size, Vector3 delta, boolean mirrorIn) {
        this.cubeList.add(new ModelCube(textureOffset.x, textureOffset.y, position.x,position.y, position.z, size.x, size.y, size.z, delta.x, delta.y, delta.z, mirrorIn, this.textureSize.getX(), this.textureSize.getY()));
        return this;
    }

    public ModelElement addCube(ModelCube cube){
    ...
    public ModelElement textureSize(float textureWidthIn, float textureHeightIn) {
        this.textureSize = new Vector2(textureWidthIn,textureHeightIn);
        return this;
    }

    public ModelElement textureOffset(float x, float y) {
    ...
    public ObjectList<ModelCube> getCubeList() {
        return cubeList;
    }
}
