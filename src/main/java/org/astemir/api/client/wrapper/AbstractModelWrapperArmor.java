...
public abstract class AbstractModelWrapperArmor<T extends Item & ITESRModel> extends HumanoidModel<LivingEntity> implements IModelWrapper<T> {
    ...
    public AbstractModelWrapperArmor() {
    ...
    public void setupAngles(LivingEntity entity, T target, ItemStack stack, EquipmentSlot equipmentSlot, HumanoidModel<?> original){
        ...
        ModelElement bipedHead = model.getModelRenderer("bipedHead");
        ModelElement bipedBody = model.getModelRenderer("bipedBody");
        ModelElement bipedLeftArm = model.getModelRenderer("bipedLeftArm");
        ModelElement bipedRightArm = model.getModelRenderer("bipedRightArm");
        ModelElement armorLeftLeg = model.getModelRenderer("armorLeftLeg");
        ModelElement armorRightLeg = model.getModelRenderer("armorRightLeg");
        ModelElement armorLeftBoot = model.getModelRenderer("armorLeftBoot");
        ModelElement armorRightBoot = model.getModelRenderer("armorRightBoot");
