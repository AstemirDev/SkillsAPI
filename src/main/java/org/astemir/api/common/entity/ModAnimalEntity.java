...
public abstract class ModAnimalEntity extends Animal implements IAnimated, IActionListener,IEventEntity, ITESRModel {

    private ActionStateMachine actionStateMachine = new ActionStateMachine();

    protected ModAnimalEntity(EntityType<? extends Animal> p_33002_, Level p_33003_) {
