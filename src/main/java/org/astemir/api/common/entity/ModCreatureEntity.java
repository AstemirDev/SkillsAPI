...
public abstract class ModCreatureEntity extends PathfinderMob implements IAnimated, IActionListener,IEventEntity, ITESRModel {

    private ActionStateMachine actionStateMachine = new ActionStateMachine();

    protected ModCreatureEntity(EntityType<? extends PathfinderMob> p_33002_, Level p_33003_) {
