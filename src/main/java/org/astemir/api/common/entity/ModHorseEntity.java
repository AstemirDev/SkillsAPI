...
public abstract class ModHorseEntity extends AbstractHorse implements IAnimated, IActionListener,IEventEntity, ITESRModel {

    private ActionStateMachine actionStateMachine = new ActionStateMachine();

    protected ModHorseEntity(EntityType<? extends AbstractHorse> p_33002_, Level p_33003_) {
