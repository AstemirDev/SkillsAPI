...
public abstract class ModMonsterEntity extends Monster implements IAnimated, IActionListener,IEventEntity,
        ITESRModel {

    private ActionStateMachine actionStateMachine = new ActionStateMachine();

    protected ModMonsterEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
