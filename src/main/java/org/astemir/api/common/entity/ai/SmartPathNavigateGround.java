...
//From Mowzie Mobs
public class SmartPathNavigateGround extends GroundPathNavigation {

    public SmartPathNavigateGround(Mob entity, Level world) {
        super(entity, world);
    }
    ...
    protected PathFinder createPathFinder(int maxVisitedNodes) {
        ...
        return new SmartPathFinder(this.nodeEvaluator, maxVisitedNodes);
    }
    ...
    protected void followThePath() {
        ...
        if (this.tryShortcut(path, new Vec3(this.mob.getX(), this.mob.getY(), this.mob.getZ()), pathLength, base, max)) {
            if (this.isAt(path, 0.1F) || this.atElevationChange(path)) {
