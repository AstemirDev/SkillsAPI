...
public class GoalFollowOwner<T extends Mob & ITamable> extends Goal {
    ...
    public GoalFollowOwner(T p_25294_, double p_25295_, float p_25296_, float p_25297_, boolean p_25298_) {
