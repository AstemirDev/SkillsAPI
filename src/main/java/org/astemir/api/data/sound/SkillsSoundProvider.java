...
public class SkillsSoundProvider extends SoundDefinitionsProvider implements IProvider {

    private Map<String,SoundDefinition> soundsToRegister = new HashMap<>();
    private String modId;

    public SkillsSoundProvider(DataGenerator generator, String modId, ExistingFileHelper helper) {
