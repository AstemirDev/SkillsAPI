...
public class ModelSharkBoat extends AdvancedModel<EntitySharkBoat> {
	...
	public static ResourceLocation MODEL = ResourceUtils.model("entity/shark_boat.geo.json");
	public static ResourceLocation ANIMATIONS = ResourceUtils.animation("entity/shark_boat.animation.json");
