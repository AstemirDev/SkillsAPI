...
public class ModEntities extends RegisterHelper{
    ...
    public static final RegistryObject<EntityType<EntityMinotaur>> MINOTAUR = register(ENTITIES, SkillsAPIMod.MOD_ID,"minotaur",new EntityProperties(EntityMinotaur::new,MobCategory.AMBIENT,1,2,()->EntityMinotaur.createAttributes().build()));
